...
public class Event implements Serializable, TimestampFromValue<Event>, StartProcTs, InjTsMs {
    ...
    @JsonCreator
    public Event(final Person newPerson, final long injTsMs) {
    ...
    @JsonCreator
    public Event(final Auction newAuction, final long injTsMs) {
        newPerson = null;
    ...
    @JsonCreator
    public Event(final Bid bid, final long injTsMs) {
        newPerson = null;
        newAuction = null;
        this.bid = bid;
        etype = EType.BID;
